...
import { MantineStyleProp, StylesRecord, MantineShadow, MantineRadius, MantineColor } from '@mantine/core';
...
declare function ContextMenuItem({ className, style, icon, iconRight, title, color, disabled, onClick, onHide, items, }: WithRequiredProperty<Omit<ContextMenuItemOptions, 'key'>, 'title'> & {
    onHide: () => void;
}): react.JSX.Element;
...
declare function ContextMenuPortal({ onHide, zIndex, ...otherProps }: ContextMenuPortalProps): react.JSX.Element;
 ...
 */
declare function ContextMenuProvider({ zIndex, shadow, borderRadius, submenuDelay, children, }: ContextMenuProviderProps): react.JSX.Element;
/**
