...
export const selectSelectedCategoryBreakdownLoaded = (state: RootState) => state.categories.selectedCategoryBreakdownLoaded;
export const selectSelectedCategoryActivity = (state: RootState) => state.categories.selectedCategoryActivity;
export const selectSortedSelectedCategoryActivity = createSelector(
  selectSelectedCategoryActivity,
  (activity) => sort(activity, (a, b) => (
