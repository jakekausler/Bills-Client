...
export const selectGraphViewDatasets = (state: RootState) => state.graphView.datasets;
...
export const selectGraphViewLoaded = (state: RootState) => state.graphView.loaded;

export const selectGraphViewError = (state: RootState) => state.graphView.error;

export const selectGraphViewSelectedAccounts = (state: RootState) => state.graphView.selectedAccounts;
