...
import { getHealthcareConfigs, postHealthcareConfig, putHealthcareConfig, deleteHealthcareConfigApi, } from './api';
export const loadHealthcareConfigs = () => async (dispatch) => {
    try {
...
export const createHealthcareConfig = (config) => async (dispatch) => {
    try {
        dispatch(setLoading(true));
...
export const updateHealthcareConfig = (id, config) => async (dispatch) => {
    try {
        dispatch(setLoading(true));
...
export const deleteHealthcareConfig = (id) => async (dispatch) => {
    try {
        dispatch(setLoading(true));
