...
import { selectEndDate, selectInterests, selectInterestsLoaded, selectNamesLoaded, selectStartDate, } from '../../features/activities/select';
import { ActionIcon, FocusTrap, Group, LoadingOverlay, Select, Stack, Table } from '@mantine/core';
import { IconDeviceFloppy, IconPlus, IconSort09, IconTrash, IconVariable, IconVariableOff, IconX, } from '@tabler/icons-react';
...
dayjs.extend(utc);
export const InterestEditor = ({ resetSelected }) => {
    ...
    const handleEnter = (index, apr) => {
        if (isNaN(apr)) {
            return;
        }
        const ints = interests.map((interest, i) => {
            if (i === index) {
                return {
                    ...interest,
    ...
    return (React.createElement(Stack, { h: "100%", w: "100%", justify: "space-between", pos: "relative" },
        ...
        React.createElement(Table, { horizontalSpacing: 4 },
            React.createElement(Table.Thead, null,
                React.createElement(Table.Tr, null,
                    React.createElement(Table.Th, { fz: "xs" }, "Start"),
                    React.createElement(Table.Th, { fz: "xs" }, "APR"),
                    React.createElement(Table.Th, { fz: "xs" }, "Compounded"),
                    React.createElement(Table.Th, { fz: "xs" }))),
            React.createElement(Table.Tbody, null, interests.map((interest, index) => (React.createElement(Table.Tr, { key: interest.id },
                React.createElement(Table.Td, null,
                    React.createElement(EditableDateInput, { size: "xs", value: interest.applicableDate, onBlur: (value) => {
                            if (!value)
                                return;
                            dispatch(updateInterests(interests.map((i) => i.id === interest.id
                                ? {
                                    ...i,
                ...
                React.createElement(Table.Td, null,
                    React.createElement(Group, { w: "100%" },
                        interest.aprIsVariable ? (React.createElement(Select, { style: { flex: 1 }, size: "xs", data: amountVariables.map((name) => ({
                                value: name,
                                label: name,
                            })), value: interest.aprVariable, onChange: (aprVariable) => {
                                if (!aprVariable)
                                    return;
                                dispatch(updateInterests(interests.map((i) => i.id === interest.id
                                    ? {
                                        ...i,
                                        aprVariable: aprVariable,
                                    }
                                    : i)));
                            }, error: validate(index, 'aprVariable', interest.aprVariable) || undefined })) : (React.createElement(CalculatorEditor, { style: { flex: 1 }, size: "xs", value: Number(interest.apr), onChange: (apr) => {
                                dispatch(updateInterests(interests.map((i) => i.id === interest.id
                                    ? {
                                        ...i,
                                    ...
                                    : i)));
                            }, error: validate(index, 'apr', interest.apr) || undefined, handleEnter: (apr) => handleEnter(index, apr) })),
                        React.createElement(ActionIcon, { size: "sm", ml: -12, onClick: () => {
                                dispatch(updateInterests(interests.map((interest, i) => ({
                                    ...interest,
                                    aprIsVariable: i === index ? !interest.aprIsVariable : interest.aprIsVariable,
                                }))));
                            } }, interest.aprIsVariable ? React.createElement(IconVariable, null) : React.createElement(IconVariableOff, null)))),
                React.createElement(Table.Td, null,
                    React.createElement(Select, { size: "xs", data: [
                            { value: 'day', label: 'Daily' },
                            { value: 'week', label: 'Weekly' },
                            { value: 'month', label: 'Monthly' },
                            { value: 'year', label: 'Yearly' },
                        ], value: interest.compounded, onChange: (compounded) => {
                            if (!compounded)
                                return;
                            dispatch(updateInterests(interests.map((i) => i.id === interest.id
                                ? {
                ...
                React.createElement(Table.Td, null,
                    React.createElement(ActionIcon, { size: "sm", mt: 6, onClick: () => {
        ...
        React.createElement(Group, { w: "100%", justify: "space-between" },
            React.createElement(ActionIcon, { size: "xl", onClick: () => {
