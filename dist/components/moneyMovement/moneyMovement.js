...
import { selectMoneyMovementLabels, selectMoneyMovementDatasets, selectMoneyMovementStartDate, selectMoneyMovementEndDate, } from '../../features/moneyMovement/select';
...
export function MoneyMovement() {
    ...
    return (React.createElement(Bar, { data: { labels, datasets: datasets ?? [] }, options: {
            scales: {
                x: {
                    stacked: true,
                },
